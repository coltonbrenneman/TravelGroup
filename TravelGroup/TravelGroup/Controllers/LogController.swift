...
class LogController { // Design pattern MCV, Model, View Controller
    ...
    // MARK: - Properties
    static let shared = LogController() // static means we can locate the property anywhere in the project. Shared = source of truth
    var logs: [Log] = []
    ...
    //  Function for delete. Where the index is, we want to remove that index, created it to be delelted.
    func delete(log: Log) {
    ...
    // MARK: - Persistence - This will perist our data in the app. When the user closes the app, the app with persit how it was last closed.
    // writing
    func save() {
